...
function Menu() {
    return {
        ...
        logged: false,
        // Список пунктов меню
        menuList: [{ name: 'Главная', link: '/', mainClass: 'main' }, { name: 'Помощь', link: '/1', mainClass: 'main' }, { name: 'Игра', link: '/2', mainClass: 'main' }, { name: 'Заработок', link: '/3', mainClass: ['main', 'open'] }, { name: 'Заработок', link: '/3', mainClass: ['main', 'open'] }, { name: 'Заработок', link: '/3', mainClass: ['main', 'open'] }, { name: 'Заработок', link: '/3', mainClass: ['main', 'open', 'names2'] }],
        // функция добавления класса
        setAddClass: function setAddClass(value) {
        ...
        render: function render(addPoint) {
